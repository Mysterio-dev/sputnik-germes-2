(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".js-toggle-sidebar")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".js-toggle-sidebar")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("sidebar-open");
                }
            }));
            if (document.querySelector(".js-toggle-menu")) document.addEventListener("click", (function(e) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".card-favorite")) new core(".card-favorite", {
            ...
            if (document.querySelector(".card-favorite-russia")) new core(".card-favorite-russia", {
                modules: [ Navigation, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".card-offer")) new core(".card-offer", {
                modules: [ Navigation, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        const btnMenu = document.querySelector(".header__dropdown-toggle");
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (!its_menu && !its_btnMenu && menu_is_active) toggleMenu();
        }));
        document.addEventListener("DOMContentLoaded", (() => {
            ymaps.ready((function() {
                var myMap = new ymaps.Map("map", {
                    controls: [],
                    center: [ 55.788814, 49.12447 ],
                    zoom: 18
                });
                let myPlacemark = new ymaps.Placemark([ 55.788814, 49.12447 ], {}, {
                    hasBalloon: false,
